...
Taken together, Figs~\ref{fig:combined_scoring_tm_avg}~and~\ref{fig:combined_scoring_tm_q} show that the results of RUPEE and mTM are roughly equal and where they do differ is a result of the differences in normalization. 

Figures similar to \figurename~\ref{fig:combined_scoring_tm_avg} but instead using CE and FATCAT for pairwise comparisons can be found in \nameref{S1_Fig} and \nameref{S2_Fig}, respectively. 
These additional figures lend further support to what has already been shown above.
...
\bibitem{Zhang2004}
Zhang Y, Skolnick J.
\newblock Scoring function for automated assessment of protein structure
  template quality.
\newblock Proteins. 2004;57(4):702--710.

\bibitem{Shindyalov1998}
...
\bibitem{Zhang2005}
Zhang Y, Skolnick J.
\newblock {TM-align: A protein structure alignment algorithm based on the
  TM-score}.
\newblock Nucleic Acids Research. 2005;33(7):2302--2309.

\bibitem{Sander1995}
Holm L, Sander C.
\newblock Dali: a network tool for protein structure comparison.
\newblock Trends in Biochemical Sciences. 1995;20(11):478 -- 480.
...
\bibitem{Holm2010}
Holm L, Rosenstr{\"{o}}m P.
\newblock {Dali server: Conservation mapping in 3D}.
\newblock Nucleic Acids Research. 2010;38(SUPPL. 2):1--5.
...
\bibitem{Ayoub2017}
Ayoub R, Lee Y.
\newblock RUPEE: Scalable protein structure search using run position encoded
  residue descriptors.
\newblock In: 2017 IEEE International Conference on Bioinformatics and
