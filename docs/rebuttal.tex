...
RUPEE always returns a sufficient number of results for the original d500 benchmark defined in \citep{Dong2018}. 
We point this out with the following text at lines 303-304.
\begin{quote}
...
We have removed the text at lines 471-477 and replaced it with the following text at lines 438-450 at the beginning of the \emph{Response times} subsection. 
