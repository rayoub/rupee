...
\begin{reply}
We added the following text along with citations at lines 46-52.
\begin{quote}
...
\begin{reply}
We added the following text along with citations at lines 63-72. The second paragraph is part of our reply to \ref{pt:r7} and is shown here to provide further context. 
\begin{quote}
...
\begin{reply}
We added the following text along with citations at lines 92-98. The last lines provides our justification for not comparing to DALI.
\begin{quote}
...
\begin{reply}
We added the following text along with citations at lines 305-309. 
\begin{quote}
...
\begin{reply}
Whereas there may be outstanding issues to address regarding coverage of the benchmarks, the number of free-modeling targets available from CASP 13 are far more limited than our benchmarks and any evaluations using such a small sample size could be misleading.
...
We have removed the text at lines 474-480 and replaced it with the following text at lines 441-453 at the beginning of the \emph{Response times} subsection. 
