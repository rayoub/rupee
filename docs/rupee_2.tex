...
Moreover, without a dependence on pre-calculated results, it is easy to apply a number of filters to the protein structures RUPEE searches in order to better focus on structures of interest.
