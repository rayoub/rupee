...
In fast mode, the top 8,000 matches from the min-hashing and LSH initial filtering are obtained along with the original gram sequences defined for the structures.
