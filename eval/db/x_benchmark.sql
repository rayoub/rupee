...
-- mtm specific
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/eval/results/benchmarks/casp_mtm_d246.txt' WITH (DELIMITER ',');

-- ssm specific
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/eval/results/benchmarks/casp_ssm_q_d240.txt' WITH (DELIMITER ',');
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/eval/results/benchmarks/casp_ssm_rmsd_d233.txt' WITH (DELIMITER ',');
