...
COPY rupee_result (version, n, db_id_1, db_id_2, rupee_rmsd, rupee_tm_score, search_mode) FROM '/home/ayoub/git/rupee/results/rupee/casp_d150_casp_chain_v06_26_2019_all.txt' WITH (DELIMITER ',');
