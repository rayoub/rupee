...
-- casp_d373
COPY rupee_result (version, n, db_id_1, db_id_2, rupee_rmsd, rupee_tm_score, search_mode) FROM '/home/ayoub/git/rupee/results/rupee/casp_d373_casp_chain_v01_01_2020_all.txt' WITH (DELIMITER ',');
COPY rupee_result (version, n, db_id_1, db_id_2, rupee_rmsd, rupee_tm_score, search_mode) FROM '/home/ayoub/git/rupee/results/rupee/casp_d373_casp_chain_v01_01_2020_top.txt' WITH (DELIMITER ',');
