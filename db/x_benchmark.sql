...
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_d150.txt' WITH (DELIMITER ',');
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_d144.txt' WITH (DELIMITER ',');
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_d34.txt' WITH (DELIMITER ',');
