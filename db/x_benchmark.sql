...
-- casp benchmarks
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_d373.txt' WITH (DELIMITER ',');
...
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_mtm_d97.txt' WITH (DELIMITER ',');
COPY benchmark (name, db_id) FROM '/home/ayoub/git/rupee/results/benchmarks/casp_mtm_d50.txt' WITH (DELIMITER ',');
